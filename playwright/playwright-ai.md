...
В пакет Playwright включені **Playwright Test Agents** — це набір AI-агентів, які автоматизують створення, генерацію та підтримку E2E тестів. Вони працюють як agentic loop: планують → генерують → виправляють тести.

Є 3 основні агенти:
* **Planner** - досліджує застосунок, формує сценарії тестування
* **Generator** - бере test plan, генерує Playwright тести
* **Healer** - запускає тести, аналізує падіння, автоматично виправляє локатори/логіку