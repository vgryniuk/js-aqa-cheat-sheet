...
---
### Prototypes
**Прототипи** в JavaScript - це механізм, який дозволяє об'єктам наслідувати властивості та методи від інших об'єктів. Вони використовуються для створення спадковості між об'єктами, дозволяючи одному об'єкту використовувати властивості і методи іншого об'єкта.

Кожен об'єкт в JavaScript має посилання на прототип, який визначає набір властивостей і методів, які можуть бути спадковані цим об'єктом.
#### Де використовуються прототипи:
* **Наслідування**: Вони використовуються для створення ієрархії об'єктів, де один об'єкт може успадковувати властивості та методи від іншого об'єкта.
* **Мінімізація пам'яті**: Прототипи дозволяють об'єктам використовувати загальні методи і властивості замість дублювання для кожного об'єкта.
```
...
// Додавання методу до прототипу класу Person
